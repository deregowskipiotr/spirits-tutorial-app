 ...
 <section id="home" className="relative min-h-screen flex flex-col pt-32 lg:pt-0">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-12 flex-1 flex flex-col justify-center">
          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center lg:items-start">
            ...
            >
              <p className="text-gray-300 text-xl md:text-2xl leading-normal font-extralight tracking-tight max-w-2xl italic opacity-90 mx-auto lg:mx-0">
            ...
            <div className="flex-1 flex justify-center lg:justify-end relative min-h-[420px] order-1 lg:order-2 w-full">
              ...
              >
                ...
                >
                  ...
                  <Link href="/spirits" className="relative z-10 block">
                    <div className="w-full bg-white/5 hover:bg-brand-accent/10 backdrop-blur-xl text-white py-4 rounded-md transition-all duration-700 text-[10px] font-bold uppercase tracking-wider border border-brand-accent/30 hover:border-brand-accent/60 cursor-pointer active:scale-[0.98] group overflow-hidden relative text-center">
