...
export default function LiqueurTypePage({ params }: { params: Promise<{ type: string }> }) {
    ...
    return (
      <main className="min-h-screen bg-[#030303] text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/spirits/liqueurs" className="text-brand-accent hover:underline">
            Back to Liqueurs Collection
          </Link>
        </div>
      </main>
    );
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        >
          <Link href="/spirits/liqueurs">
            ...
            >
               <FiArrowLeft className="text-sm" /> Back to Liqueurs Products
            </button>
          </Link>
        </motion.div>
