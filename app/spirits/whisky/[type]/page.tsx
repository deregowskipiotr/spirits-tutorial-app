...
import { whiskyData } from "@/app/data"; // Adjust path as needed
...
export default function WhiskyTypePage({ params }: { params: Promise<{ type: string }> }) {
    ...
    return (
      <main className="min-h-screen bg-[#030303] text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/spirits/whisky" className="text-brand-accent hover:underline">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        >
          <Link href="/spirits/whisky">
            ...
            >
              <FiArrowLeft className="text-sm" /> Back to Whisky Products
            </button>
          </Link>
        </motion.div>
