...
import { vodkaData } from "@/app/data"; // Adjust path as needed
...
export default function VodkaTypePage({ params }: { params: Promise<{ type: string }> }) {
    ...
    return (
      <main className="min-h-screen bg-[#030303] text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/spirits/vodka" className="text-brand-accent hover:underline">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        >
          <Link href="/spirits/vodka">
            ...
            >
              <FiArrowLeft className="text-sm" /> Back to Vodka Products
            </button>
          </Link>
        </motion.div>
