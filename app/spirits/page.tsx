...
export default function SpiritsPage() {
  ...
  return (
    <main className="min-h-screen bg-[#030303] font-old-standard overflow-x-hidden">
      {/* Dynamic Background */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 lg:py-32">
        ...
        >
          ...
          <p className="text-gray-400 text-lg md:text-xl font-extralight tracking-wide max-w-2xl mx-auto italic leading-relaxed">
              ...
              >
                <Link href={`/spirits/${category.slug}`}>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 text-brand-accent/60 text-[10px] font-bold tracking-[0.3em] uppercase transition-all duration-500 group-hover:gap-5 group-hover:text-brand-accent">
        ...
        <div className="mt-32 text-center">
          <Link href="/">
            <button className="text-gray-500 hover:text-brand-accent/80 text-[10px] font-light uppercase py-2 transition-colors duration-500 cursor-pointer tracking-[0.4em] flex items-center gap-4 mx-auto">
